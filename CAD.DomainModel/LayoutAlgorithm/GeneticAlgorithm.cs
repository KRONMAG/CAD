...
namespace CAD.DomainModel.LayoutAlgorithm
{
    ...
    public class GeneticAlgorithm
    {
        ...
        /// </summary>
        /// <param name="args">Параметры генетического алгоритма</param>
        /// <param name="individual">Особь, пригодность которой нужно вычислить</param>
        ...
        /// <returns>Потомок с мутацией, если она была осуществлена, иначе - исходный потомок</returns>
        ...
        /// На основе каждой пары формируются два потомка
        /// </summary>
        ...
        /// <returns>Особи, прошедшие отбор</returns>
